...
import { Avatar, Modal, EmptyState, PageLoader } from '../../components/ui';
                    ...
                    <td>
                      <div style={{display:'flex',alignItems:'center',gap:8}}>
                        ...
                        <div style={{minWidth:0}}>
                          ...
                          <div style={{fontSize:10.5,color:'var(--t3)',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap',maxWidth:140}}>{b.email}</div>
                        </div>
                      </div>
                    </td>
            ...
            <div style={{display:'flex',alignItems:'center',gap:16,paddingBottom:16,borderBottom:'1px solid var(--border)'}}>
              ...
              <div style={{flex:1}}>
                ...
                <div style={{fontSize:12,color:'var(--t3)',marginTop:2}}>
                  Contact: <strong>{selected.displayName}</strong> • {selected.email}
                </div>
